  ...
  return (
    <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif text-background leading-tight animate-fade-up">
          Where Coffee Meets<br />
          <span className="italic">Atmosphere</span>
        </h1>
        
        <p className="mt-6 md:mt-8 text-lg md:text-xl text-background/90 max-w-2xl mx-auto leading-relaxed animate-fade-up-delay-1">
